...
- `llm_literature_extraction/species_index.yaml` lists candidate species grouped by family. A species is "done" iff its file exists in `llm_literature_extraction/species/`.
