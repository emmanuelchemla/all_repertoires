...
- `species_index.yaml` lists candidate species grouped by family. For each database, a species is "done" iff its file exists in that database's `species/` directory.
